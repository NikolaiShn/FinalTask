...
public interface SectionRepository extends JpaRepository<Section, Long> {
    ...
    List<Section> findSectionByNameAndKnowledgeDirectoryName(@Param("sectionName") String sectionName, @Param("knowledgeDirectoryName") String knowledgeDirectoryName);
}
